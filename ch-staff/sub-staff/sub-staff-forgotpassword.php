...
<head>
    <title>Sub-staff</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Load an icon library to show a hamburger menu (bars) on small screens -->
    <link rel="stylesheet" type="text/css" href="../../styles/style.css">
    <link rel="stylesheet" type="text/css" href="styles/sub-staff-forgotpassword.css">
</head>
...
<body>
    ...
    <div class="box">
        ...
        <form action="sub-staff-forgotpassword.php" method="POST">
            <br><br>
...
if (isset($_POST['forgot']))
   {
	   ...
	   if ($password==$cpassword){
		 ...
		 {    $passwd = md5($password);
             $query1="UPDATE sub_staff SET password='$passwd' WHERE email='$email'";
