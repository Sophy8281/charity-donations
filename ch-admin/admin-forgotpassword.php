...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styles/admin-forgotpassword.css">
</head>
...
<body>
    ...
    <div class="box">
        ...
        <form action="admin-forgotpassword.php" method="POST">
            <input class="input" type="name" name="username" required>
...
if (isset($_POST['forgot']))
   {
	   ...
	   if ($password==$cpassword){
		 ...
		 {
             $passwd=md5($password);
             $query1="UPDATE admin SET password='$passwd' WHERE username='$username'";
		 if(mysqli_query($conn,$query1)){
             echo "Go to ...<a href='index.php'>login</a>";
         }else {echo "Error";}
       }else {echo'<p style="color:red">Username not found!!!!</p>';}
